...
const LoginPage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    setLoading(true);
    setTimeout(() => {
      alert("Welcome back to CodeBay! 🚀");
      setLoading(false);
    }, 1500);
  };

  return (
    // Background updated to match theme
    <div className="relative min-h-screen bg-gradient-to-br from-blue-900 via-blue-700 to-indigo-900 flex items-center justify-center p-4 sm:p-6 lg:p-8 overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md md:max-w-4xl">
        {/* Card set to slight transparency to let icons peek through */}
        <div className="bg-white bg-opacity-95 rounded-3xl shadow-2xl border border-blue-100 overflow-hidden flex flex-col md:flex-row md:items-stretch">
          ...
          <section className="flex flex-col items-center justify-center text-center md:w-2/5 bg-slate-50/80 p-6 md:p-8 border-b md:border-b-0 md:border-r border-gray-100">
            <img src="/Logo_6.png" alt="Logo" className="h-12 md:h-16" />
            ...
            <div className="hidden md:block space-y-4 text-sm text-gray-600">
              <div className="p-4 bg-blue-50/50 rounded-xl border border-blue-100">
                ...
                <p className="mt-1 leading-relaxed">
                  Log in to pick up right where you left off in your coding
                  journey.
                </p>
              </div>
            </div>
          ...
          <div className="flex-1 px-6 py-8 md:px-12 md:py-10 lg:py-12">
            ...
            <form onSubmit={handleSubmit} className="space-y-4 md:space-y-5">
              ...
              <div className="space-y-1">
                ...
                <div className="text-right">
                  <NavLink
                    to="/forgot-password"
                    className="text-xs text-[#153498] hover:underline font-medium"
                  >
                    Forgot password?
                  </NavLink>
                </div>
            ...
            <div className="relative flex py-6 items-center">
              ...
              <span className="flex-shrink mx-4 text-gray-400 text-[10px] md:text-xs uppercase tracking-widest font-medium">
                Or continue with
              </span>
              <div className="flex-grow border-t border-gray-200"></div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center">
              <button className="px-4 py-2.5 border border-gray-200 flex justify-center items-center rounded-2xl cursor-pointer hover:bg-gray-50 transition-all flex-1">
                ...
                <span className="font-bold text-[11px] md:text-[12px] whitespace-nowrap text-gray-700">
                  Login with <span className="text-[#153498]">GitHub</span>
                </span>
              </button>
              ...
              <button className="px-4 py-2.5 border border-gray-200 flex justify-center items-center rounded-2xl cursor-pointer hover:bg-gray-50 transition-all flex-1">
                ...
                <span className="font-bold text-[11px] md:text-[12px] whitespace-nowrap text-gray-700">
                  Login with <span className="text-[#153498]">Google</span>
                </span>
              </button>
            </div>
          </div>
